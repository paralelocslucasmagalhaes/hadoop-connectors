...
public abstract class RetryHttpInitializerOptions {
  ...
  public static final Duration DEFAULT_INITIAL_RETRY_INTERVAL = Duration.ofSeconds(1);
  public static final Duration DEFAULT_MAX_RETRY_INTERVAL = Duration.ofSeconds(20);
  ...
  public static Builder builder() {
    return new AutoValue_RetryHttpInitializerOptions.Builder()
        ...
        .setInitialRetryInterval(DEFAULT_INITIAL_RETRY_INTERVAL)
        .setMaxRetryInterval(DEFAULT_MAX_RETRY_INTERVAL)
  ...
  public abstract Duration getInitialRetryInterval();

  public abstract Duration getMaxRetryInterval();
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setInitialRetryInterval(Duration initialRetryInterval);

    public abstract Builder setMaxRetryInterval(Duration maxRetryInterval);
